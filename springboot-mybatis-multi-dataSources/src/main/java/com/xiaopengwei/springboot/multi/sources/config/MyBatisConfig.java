...
import com.xiaopengwei.springboot.multi.sources.util.DynamicDataSource;
...
public class MyBatisConfig implements EnvironmentAware {
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        scannerConfigurer.setBasePackage("com.xiaopengwei.springboot.multi.sources.repository");
        Properties props = new Properties();
        props.setProperty("mappers", "tk.mybatis.repository.common.Mapper");
    ...
    public SqlSessionFactory sqlSessionFactory(DynamicDataSource ds) throws Exception {
        ...
        fb.setTypeAliasesPackage("com.xiaopengwei.springboot.multi.sources.entity");// 指定基包
        fb.setMapperLocations(resolver.getResources("classpath*:repository/**/*.xml"));
